...
const FoodPartnerLogin = () => {
    ...
    if(success === true){
      try {
        const response = await axios.post("http://localhost:3000/api/foodPartner/login", formData, {
  ...
  return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-400 via-red-400 to-yellow-300">
            <div className="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-md">
                ...
                <p className="text-xl font-medium text-center mb-5">Welcome Partner — Sign in to continue</p>
                ...
                <p className="text-center text-gray-500 mt-6">
                    ...
                    <a href="/foodPartnerSignup" className="text-red-400 font-semibold hover:underline">
                        Sign Up
                    </a>
                </p>
            </div>
